...
stock_compute = Button(text="COMPUTE", font=("Arial", 15, "bold"), bg="#7a3530", fg="white")
Stock_entry=Entry(width=20)
Display=Label(text="THIS IS A TEST",font=("Arial",30,"bold"),bg="white",fg="white",width=15,height=15)
